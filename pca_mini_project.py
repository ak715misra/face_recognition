...
# "[Labeled Faces in the Wild](http://vis-www.cs.umass.edu/lfw/)", aka [LFW_ Download](http://vis-www.cs.umass.edu/lfw/lfw-funneled.tgz) (233MB). [Original source](http://scikit-learn.org/stable/auto_examples/applications/face_recognition.html).
...
n_components = 150
#n_components = [10, 15, 25, 50, 100, 250, 300]
...
# Variance explained by the first PCA: 0.19346534 or 19.34%
# Variance explained by the 2nd PCA: 0.1511682 or 15.11%
...
# With the addition of PCs, we wee F1 score going higher means better performance but only upto a point e.g. 0.69 for 
# n_components=250. Addional PCs would not increase the F1 score.
...
# We see F1 score going higher and that simply means classifier is doing better.
...
# Yes, We do notice overfitting. F1 score increases only up to a point. When number of PCs goes beyond 250, it starts going 
# down. Also dimensionality reduction is helping the performance because PCA is reducing the number of features from 1800 to 
# 150 without losing much of the info. We notice the F1 score increasing during this process.
